...
install(Options) ->
    ...
    case resolve_destination(Options, fun os:getenv/1) of
        {ok, Parent} ->
            case install(Source, Parent, maps:get(force, Options)) of
                {ok, Target} ->
